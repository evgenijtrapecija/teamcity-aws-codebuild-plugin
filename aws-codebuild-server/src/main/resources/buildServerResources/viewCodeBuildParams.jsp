...
<div class="parameter">
    ${stream_logs_label}: <strong><props:displayCheckboxValue name="${stream_logs_param}"/></strong>
</div>

<div class="parameter">
    ${cloudwatch_region_label}: <strong><props:displayValue name="${cloudwatch_region_param}" emptyValue="<em>Use CodeBuild region</em>"/></strong>
</div>

<div class="parameter">
    ${debug_logs_label}: <strong><props:displayCheckboxValue name="${debug_logs_param}"/></strong>
</div>