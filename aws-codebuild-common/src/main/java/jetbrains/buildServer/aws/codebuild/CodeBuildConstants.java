...
public interface CodeBuildConstants {
  ...
  long POLL_INTERVAL = 3000; // Reduced from 10 seconds to 3 seconds for faster monitoring
  ...
  String BUILD_ID_ENVIRONMENT_VARIABLE_FORMAT = "AWS_CODEBUILD_%s_BUILD_ID";

  // CloudWatch Logs related constants
  String STREAM_LOGS_PARAM = "codebuild.stream.logs";
  String STREAM_LOGS_LABEL = "Stream CloudWatch logs to build log";
  
  String CLOUDWATCH_REGION_PARAM = "codebuild.cloudwatch.region";
  String CLOUDWATCH_REGION_LABEL = "CloudWatch region (leave empty to use same as CodeBuild region)";
  
  String DEBUG_LOGS_PARAM = "codebuild.debug.logs";
  String DEBUG_LOGS_LABEL = "Enable debug logs";
  
  String LOG_GROUP_PREFIX = "/aws/codebuild/";
  long LOG_FETCH_INTERVAL = 2000; // 2 seconds for faster log streaming
  int MAX_LOG_EVENTS_PER_REQUEST = 1000;
